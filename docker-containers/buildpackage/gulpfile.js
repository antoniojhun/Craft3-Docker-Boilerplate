...
// components - build .vue VueJS components, remove ,{ allowEmpty: true } when vueJs file is ready
function components() {
    $.fancyLog("-> Compiling Vue Components");
    return gulp.src(pkg.globs.components, { allowEmpty: true })
        .pipe($.plumber({ errorHandler: onError }))
...
function watchFiles() {
    gulp.watch([pkg.paths.src.scss + "**/*.scss"], compileStyle);
    gulp.watch([pkg.paths.src.css + "**/*.css"], compileStyle);
    gulp.watch([pkg.paths.src.js + "**/*.js"], compileJs);
...
const compileStyle = gulp.series(scss, css);
const compileJs = gulp.series(jsBabel, jsInline, js);
const build = gulp.parallel(css);
const watch = gulp.parallel(watchFiles, browserSync);

exports.css = gulp.series(scss, css);
exports.build = build;
exports.watch = watch;
